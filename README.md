About parso-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parso-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5373&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parso-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parso` can be installed with `conda`:
...
It is possible to list all of the versions of `parso` available on your platform with `conda`:
...
```
mamba search parso --channel conda-forge
```
...
mamba repoquery search parso --channel conda-forge

# List packages depending on `parso`:
mamba repoquery whoneeds parso --channel conda-forge

# List dependencies of `parso`:
mamba repoquery depends parso --channel conda-forge
```
